...
import EarlyBadge from "../assets/EarlyBadge.svg"

const EarlyAdoptersBadge = () => {
  return (
    <div className="relative w-[200px]">
      <div className="relative flex justify-center hover:top-[6px] hover:left-[5px]">
        <Image alt="badge" src={EarlyBadge} className="rounded-lg z-40 relative " />
...
export default EarlyAdoptersBadge;
